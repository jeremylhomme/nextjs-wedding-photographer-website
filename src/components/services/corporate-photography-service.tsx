...
export function CorporatePhotographyService() {
  const t = useTranslations('service-page.corporate-photography');

  const CORPORATE_IMAGES = Array.from({ length: 4 }, (_, i) => ({
    src: `/infinite-slider/corporate-photography/slider-jeremydan-corporate-photography-${String(i + 1).padStart(3, '0')}-optimized.webp`,
    alt: t(`slider.slider-image-${i + 1}`) as string
  }));

  const CORPORATE_IMAGES_2 = Array.from({ length: 3 }, (_, i) => ({
    src: `/infinite-slider/corporate-photography/slider-jeremydan-corporate-photography-${String(i + 5).padStart(3, '0')}-optimized.webp`,
      ...
      <div className='mx-auto mt-12 max-w-4xl'>
        <div className='flex flex-col'>
          <div className='grid gap-8 md:gap-12 lg:grid-cols-2'>
            ...
            <div className='order-2 md:order-none'>
              <FadeInImage
                src='/services/corporate-photography/jeremydan-corporate-photography-001-optimized.webp'
                alt={t('alt1')}
                className='h-full w-full object-cover'
              />
            </div>
          ...
          <div className='py-8'>
            ...
            <FadeInImage
              src='/services/corporate-photography/jeremydan-corporate-photography-002-optimized.webp'
              alt={t('alt2')}
          ...
          <div className='mb-8'>
            ...
            <div className='my-8 grid grid-cols-1 gap-4 md:grid-cols-2'>
              <div className='relative h-[600px] overflow-hidden'>
                <FadeInImage
                  src='/services/corporate-photography/jeremydan-corporate-photography-003-optimized.webp'
                  alt={t('alt3')}
              ...
              <div className='relative h-[600px] overflow-hidden'>
                <FadeInImage
                  src='/services/corporate-photography/jeremydan-corporate-photography-004-optimized.webp'
                  alt={t('alt4')}
                  className='absolute inset-0 h-full w-full object-cover'
                />
              </div>
            ...
            <div className='relative h-[500px] overflow-hidden'>
              <FadeInImage
                src='/services/corporate-photography/jeremydan-corporate-photography-005-optimized.webp'
                alt={t('alt5')}
            ...
            <div className='my-8 grid grid-cols-1 gap-4 md:grid-cols-2'>
              <div className='relative h-[500px] overflow-hidden'>
                <FadeInImage
                  src='/services/corporate-photography/jeremydan-corporate-photography-006-optimized.webp'
                  alt={t('alt6')}
                  className='absolute inset-0 h-full w-full object-cover'
                />
              </div>
              <div className='relative h-[500px] overflow-hidden'>
                <FadeInImage
                  src='/services/corporate-photography/jeremydan-corporate-photography-007-optimized.webp'
                  alt={t('alt7')}
                  className='absolute inset-0 h-full w-full object-cover'
                />
              </div>
            </div>
            <h3 className='mb-4 font-semibold'>{t('subtitle9')}</h3>
            <p className='mb-4 leading-relaxed text-muted-foreground'>
              {t('bullet17')}
            </p>
            ...
            <div className='my-8 grid grid-cols-1 gap-4 md:grid-cols-2'>
              <div className='relative h-[600px] overflow-hidden'>
                <FadeInImage
                  src='/services/corporate-photography/jeremydan-corporate-photography-008-optimized.webp'
                  alt={t('alt8')}
                  className='absolute inset-0 h-full w-full object-cover'
                />
              </div>
              <div className='relative h-[600px] overflow-hidden'>
                <FadeInImage
                  src='/services/corporate-photography/jeremydan-corporate-photography-009-optimized.webp'
                  alt={t('alt9')}
                  className='absolute inset-0 h-full w-full object-cover'
                />
              </div>
          ...
          <div className='mb-8'>
            ...
            <h4 className='mb-4 font-semibold'>{t('subtitle14')}</h4>
            <p className='mb-4 leading-relaxed text-muted-foreground'>
              {t('content18')}
            </p>
            <FadeInImage
              src='/services/corporate-photography/jeremydan-corporate-photography-010-optimized.webp'
              alt={t('alt10')}
              className='h-full w-full object-cover'
            />
          </div>
