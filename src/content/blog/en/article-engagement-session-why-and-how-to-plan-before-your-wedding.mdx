...
category: 'article'
altGridImage:
  'A couple walks hand in hand down a gravel path surrounded by greenery, with
  an archway overhead, captured through the lens of Jeremy Dan, a wedding
  photographer based in Sceaux, Hauts-de-Seine.'
